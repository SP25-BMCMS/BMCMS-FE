...
export const mockCracks: Crack[] = [
  {
    ...
    description:
      "A wall crack is a visible line or split on the surface of a wall, often caused by structural movement, settling, or external stress. It can vary in size, from fine hairline cracks to larger, more noticeable gaps, and may affect the wall's appearance and stability.",
  ...
  },
  {
    ...
    description:
      'A ceiling crack with water leakage indicates potential water damage from plumbing issues or roof leaks. The crack appears to be allowing water to seep through, which could lead to further structural damage, mold growth, and deterioration if not addressed promptly.',
