...
import { BuildingOfficeIcon, MapPinIcon, CalendarIcon, CheckCircleIcon } from '@heroicons/react/24/outline'
            ...
            <div className="fixed inset-0 flex items-center justify-center p-4">
                <Dialog.Panel className="mx-auto max-w-2xl w-full rounded-lg bg-white dark:bg-gray-800 p-6 shadow-xl">
                    ...
                    <div className="mb-8 p-6 bg-gray-50 dark:bg-gray-700 rounded-xl border border-gray-200 dark:border-gray-600">
                        <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Schedule Job Details</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="font-medium text-gray-900 dark:text-white">{scheduleJob.building.name}</p>
                                </div>
                            </div>
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="font-medium text-gray-900 dark:text-white">{scheduleJob.building.area.name}</p>
                                </div>
                            </div>
                            <div className="flex items-start space-x-3">
