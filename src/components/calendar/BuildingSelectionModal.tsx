...
const BuildingSelectionModal: React.FC<BuildingSelectionModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-[60] building-selection-modal" onClick={(e) => e.stopPropagation()}>
            <div className="absolute inset-0 bg-black opacity-50" onClick={onClose}></div>
            <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-md" onClick={(e) => e.stopPropagation()}>
                <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-100">Select Buildings</h2>
                    ...
                    {buildings.length > 0 ? (
                        buildings.map((building) => (
                            <div
                                ...
                                className={`p-3 border rounded-md cursor-pointer transition ${selectedBuildings.includes(building.buildingId)
                            ...
                            >
                                <div className="flex items-center">
                                    <div className={`w-5 h-5 mr-3 rounded border ${selectedBuildings.includes(building.buildingId)
                                    ...
                                    <div>
                                        <div className="font-medium text-gray-800 dark:text-gray-100">{building.name}</div>
