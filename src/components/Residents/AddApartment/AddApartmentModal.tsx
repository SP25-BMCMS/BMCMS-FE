      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-full max-w-md overflow-hidden">
        ...
        {resident && (
          <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border-b border-blue-100 dark:border-blue-800/30">
            <div className="flex items-center">
              ...
              <div>
              <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Assigning apartment for:</p>
        ...
        <form onSubmit={handleSubmit} className="p-4">
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="buildingDetail" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                Building Detail
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
          ...
          <div className="mt-6">
            <button
              ...
              className={`w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 ${
                isSubmitting || isLoading ? 'opacity-50 cursor-not-allowed' : 'hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500'
              }`}
            >
              {isSubmitting ? (
                <>
