...
const AddResident: React.FC<AddResidentProps> = ({ isOpen, onClose, onAdd }) => {
  ...
  const handleSubmit = () => {
    const formattedData = {
      ...formData,
      dateOfBirth: formData.dateOfBirth ? formData.dateOfBirth.toLocaleDateString('en-CA') : '',
    };
    onAdd(formattedData);
    onClose();
  };
      ...
      <div className="p-6 space-y-4">
        <div className="space-y-4">
          ...
          <div className="flex items-center">
            <label className="w-1/3 text-sm font-medium text-gray-700">FullName</label>
            <input
              type="text"
              name="fullName"
          ...
          {/* Created Date */}
          <div className="flex items-center">
            <label className="w-1/3 text-sm font-medium text-gray-700">Created Date</label>
            <input
              type="text"
              name="createdDate"
          ...
          <div className="flex items-center">
            ...
            {['resident'].length > 1 ? (
              ...
              <span className="w-2/3 px-3 py-2 border border-black rounded-[7px] shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                {formData.role}
              </span>
            )}
          </div>
          ...
          {/* Area */}
          <div className="flex items-center">
            <label className="w-1/3 text-sm font-medium text-gray-700">Area</label>
            <select
              name="area"
              value={formData.area}
              onChange={handleChange}
