...
import { FaUser, FaCalendarAlt, FaClipboardList, FaCheckCircle, FaExclamationTriangle, FaMoneyBillWave, FaImages } from 'react-icons/fa'
            ...
            <div className="p-6">
              ...
              {error ? (
                <div className="text-center py-6">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">Unable to load Inspection data.</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                          <div>
                            ...
                            <div className="flex items-center text-sm">
                              ...
                              <span className="text-gray-700 dark:text-gray-300">
                                Total Cost: {new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(Number(inspection.total_cost))}
                              </span>
                            </div>
                          </div>
