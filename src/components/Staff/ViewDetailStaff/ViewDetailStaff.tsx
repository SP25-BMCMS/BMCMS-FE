...
const ViewDetailStaff: React.FC<ViewDetailStaffProps> = ({
  isOpen,
  onClose,
  staffId
}) => {
    ...
    >
      {isLoading ? (
        ...
        <div className="text-center p-6">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Error Loading Staff Details</h3>
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <div className="flex flex-wrap justify-center sm:justify-start gap-2 mt-2">
                <span className={`px-3 py-1 rounded-full text-xs font-semibold ${getRoleStyle(staffDetail.role)}`}>
                  {staffDetail.role}
                </span>
                
                <span className={`px-3 py-1 rounded-full text-xs font-semibold border ${getStatusStyle(staffDetail.accountStatus)}`}>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 dark:text-white">{formatDate(staffDetail.dateOfBirth)}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 dark:text-white text-xs md:text-sm">{staffDetail.userId}</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 dark:text-white">{staffDetail.userDetails.department.departmentName}</p>
                      <p className="text-gray-500 dark:text-gray-400 text-sm">{staffDetail.userDetails.department.description}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 dark:text-white">{staffDetail.userDetails.department.area}</p>
                    </div>
                  </div>
                </div>
              ) : (
