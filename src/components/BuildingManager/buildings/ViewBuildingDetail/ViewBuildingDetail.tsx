...
import { Building, MapPin, Calendar, Home, Layers, CheckCircle, ArrowRight } from 'lucide-react';
    ...
    >
      {isLoading ? (
        ...
        >
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Không thể tải thông tin</h3>
          ...
          >
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
              <div className="w-32 h-32 flex-shrink-0 rounded-xl overflow-hidden shadow-md border-2 border-gray-200 dark:border-gray-700">
                <img
                  src={buildingDetail.building.imageCover || "https://via.placeholder.com/128?text=No+Image"}
              ...
              <div className="flex-1 text-center md:text-left">
                <div className="flex flex-wrap justify-center md:justify-start gap-2 mb-3">
                  <span className={`px-3 py-1 rounded-full text-sm font-semibold shadow-sm ${getStatusStyle(buildingDetail.building.Status)}`}>
            ...
            >
              ...
              <div className="space-y-3">
                <div className="flex justify-between pb-2 border-b border-gray-100 dark:border-gray-700">
                  ...
                  <span className="text-gray-900 dark:text-white text-sm font-medium truncate max-w-[200px]" title={buildingDetail.buildingId}>
