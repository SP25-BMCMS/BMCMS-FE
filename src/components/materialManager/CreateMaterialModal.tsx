                ...
                >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        >
                            ...
                            <div className="relative status-dropdown" style={{ marginBottom: showStatusDropdown ? '120px' : '0px', transition: 'margin-bottom 0.3s' }}>
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    ...
                                    >
                                        <div className="py-1">
                                            ...
                                            >
                                                ...
                                                {formData.status === "ACTIVE" && (
                                                    <svg className="w-4 h-4 ml-auto text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
